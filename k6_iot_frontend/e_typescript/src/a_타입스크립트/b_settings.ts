...
4. TypeScript 설정파일 (tsconfig.json) 생성 및 설정
5. 기본 소스 구조 구성 (src 등)
6. 빌드 & 싩행 테스트
...
// 1. Node.js 설치
//  설치 확인
//  cmd >> node -v (node --version), npm -v(npm --version) 
// +) npx -v (npx --version)

// 2. npm 확인
// +) Node.js 설치시 npm이 자동 설치
...

{
  ...
  "name": "e_typescript",   //? 프로젝트 이름설정(기본값 - 현재 디렉토리 이름)
...
// === 설치 방법 ==
// git bash 사용 > TS 프로젝트 최상단

//? npm 을 사용 하여 '타입스크립트 패키지 ' 설치
// - 전역 설치 ('g' 옵션, global)
// : 개발자 컴퓨터 전체에 기능 추가
...
//    >> npm으로 설치시 프로젝트 로컬에만 설치
//    >> npx 는 npm이 제공하는 실행 도우미
...
//     "module": "CommonJS",                //? Node.js는 CommonJS모듈 사용
//     "rootDir": "./src",                  //? TypeScript 원본 코드 폴터
//     "outDir": "./dist",                  //? 컴파일된 JS 출력폴더
//     "strict": true,                      //? 타입 검사 간와
