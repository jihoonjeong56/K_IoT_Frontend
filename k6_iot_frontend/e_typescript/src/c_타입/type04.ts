// ! Union 타입
// : 여러 타입 '중' 하나가 될 수 잇는 값을 나타내느 방법
// - 갑에 허용된 타입을 두 개 이상으로 지정
// - OR 연산자(A 또는 B... 중에서)
...
// >> TS는 변수의 타입이 어노테이션 또는 초기화값으로 지정
...
function getAge(age: Union) {
  ...
  //  +) 유니언 타입의 변수는 포함된 타입에서 모두 포함하는 속성과 메서드만 사용 가능하다.
  // age.toFixed()
  // age.toUpperCase();
