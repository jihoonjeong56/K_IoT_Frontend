...
//! DOM
// : 웹 페이지를 문서 객체로 조작하고 관리할 있는 인터페이스

//! DOM 사용 방법
// : JS에서 HTML의 요소를 문서 객체로서 선택/추가/수정/삭제 하는 메서드와 속성 사용

//! DOM 조작 방법

//? 1) DOMContentLoaded 이벤트
// : JS 내에서 문서 객체 조작 시 HTML 의 모든 문서 구조(내용)가 모두 로드된 이후에 이벤트 발생
...
document.addEventListener("DOMContentLoaded", () => {
  // querySelector
  // : 요소 단 한개만 추출 (여러 개일 경우 제일 상단의 요소만 가져옴)
...
//      : 해당 클래스명을 가진 요소를 '컬렉션 객체'로 반환 (유사배열)
//      >> 배열 메서드, 인덱스 번호 사용 안됨. (사용 권장 x)
