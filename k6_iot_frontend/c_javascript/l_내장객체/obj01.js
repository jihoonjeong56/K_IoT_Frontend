...
console.log(num.toFixed()); // 자릿수 지정하지 않으면 - 소수점 전체 반올림(정수 반환)

//! 2) isNaN(), isFinite()
// : 각각 NaN 값, Infinity() 값인지 확인
// cf) 위 두 값은 비교연산자 사용 불가
let notNum = Number("숫자로 벼환할 수없는 값");
...
// >> 양수 또는 음수를 0으로 나우면 각각 무한대 수가 생성

console.log(10 / 0);
console.log(-10 / 0);

// cf) finity(finify 끈) : 유한
//     infinity : 무한
...
//! 3) length
// : 문자열 길이 반환
console.log(" hello, JS ^^ ".length); // 공백과 기호 모두 길이로 측정
