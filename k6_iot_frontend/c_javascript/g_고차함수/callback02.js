...
// >>> 콜백 함수의 인자값은 필수 아님(주로 value만 사용)
//      : 사용하지 않는 인자값은 생략 가능
...
//  인자명 변경가능(순서가 보장된다는 가정하에)

// basicArray.filter(function (value) {
//   return value % 2 === 0;
// });
console.log(`원래배열 ${basicArray} / 짝수 배열 ${evenNumbers}`);
...
//   return car.length > 4;
//   함수 실행수 true 를 반환한 요소만 새로운 배열에 담아 반환
// });
...
let a = numbersArray.filter((nums) => nums % 2 === 0);
console.log(a);
