...
console.log(sports[1]); // 배열명[인텍스번호]

sports[2] = "basketball";
console.log(sports);

// cf) 참조 자료형: 배열, 함수, 객체 등
//    >> 실제 데이터 가 아닌, 메모리 주소를 저장하여 '참조'
...
sports[5] = "배구";
// [ '축구', '야구', 'basketball', <2 empty items>, '배구' ]
sports[4] = "탁구";
// [ '축구', '야구', 'basketball', <1 empty item>, '탁구', '배구' ]
console.log(sports);
...
// 2) 삭제: pop()    - 맨 마지막 요소 제거( + 수정된 배열 길이를 반환)
...
//? splice()
// 1) 추가: splice(시작 인텍스, 0, 아이템 나열)
//        >> 3번째에 인자값이 있으면 추가로 인식
