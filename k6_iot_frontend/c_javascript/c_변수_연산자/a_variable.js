...
// 2. 차이점
// - let : 동일한 영역 내에서 재선언 불가, 호이스팅 가능(선언부에 올려지고 초기화되지 않아 "접근불가")
// - var : 동일한 영역 내에서 재선언 가능, 호이스팅 가능(선언시 undefined 초기화: 접근가능)

//? TDZ(Temporal Dead Zone): 변수가 선언되고 초기화되기까지의 공간
// - let은 TDZ에 있을 경우 사용불가
// - var은 TDZ의 변수값 사용가능
...
// letVar3 = 30; // 선언전 초기화 
// console.log(letVar3); //ReferenceError: Cannot access 'letVar3' before initialization
