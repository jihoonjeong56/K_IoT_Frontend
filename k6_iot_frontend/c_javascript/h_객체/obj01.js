...
// >> 이름, 나이, 성별, 직업, 주민등록번호, 키 등등등등등

//? - 기능(동작, 메서드): 함수 선언 -
// : 객체가 수행할 수 잇는 행동이나 기능 정의
// : 속성을 활용하거나 조작 가능
// >> 공부하다, 먹다, 걷다, 말하다 등등등등등등

//? '자동차'라는 객체 정의
// - 속성
//    모델명: 'Kia K9' / 색상: 'Black' /  연식: 2025 / 현재 속도 : 0
// - 기능
//    가속하다: '현재속도 증가' / 정지하다: '차량을 정지' / 경적을 울리다: '경적을 울림'
...
/*
  ...
  +) 각각긔 멤버(키와 값)는 콜론(:) 으로 분리
*/

let name01 = ["j", "jh", "177"];

//! 객체 '리터럴' 방식
// : 가장 간당하고 직관적인 객체 생성 방식
// - 중괄호를 사용하여 객체를 선언하고 초기화(내부에 속성과 메서드 정의)
// - 같은 형태의 객체르 여러 개 만들 때 중복 증가
...
function Human(nameParam, ageParam) {
  ...
  // this는 현재 객체 그 자체
  // : 좌항의 .name / .age와 같이 해당 객체 내의 속성에 접근하려고 할 때, 해당 필드(프로퍼티)가 생성(선언)
  this.name = nameParam;
  this.age = ageParam;

  // 좌항의 .greet와 같이 해당 객체의 행위에 접근
  this.greet = function () {
...
let person1 = new Human("aaa", 26);
let person2 = new Human("ddd", 23);
