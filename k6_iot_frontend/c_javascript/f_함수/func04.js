...
//! 1. 기본 매개변수(default)
// : 함수의 인자를 전달하지 않았을 경우 사용되는 기본값 정의
...
// == 구현방법 ==
// : 매개변수명 앞에 ...(sprad 연산자)를 통해 붙여 정의
// > 데이터가 정홝하게 지정될 변수가 있는 경우 매개변수 목록들 보다 마지막에 이치

function spreadFunc(num1, num2, ...nums) {
  // num1 과 num2에는 정확한 데이터값이 할당
  // : 배열을 담는 변수
  console.log(nums);
}
...
console.log(findMin(21, 324, 232, 23, 55, 3, 45, 89));
