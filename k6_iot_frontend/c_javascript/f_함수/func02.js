//% == 자바스크립트 함수 ==
//! 1. 함수 구현 방법
// function 함수명(매배견수 나열){
//? 매개변수: 합수의 입력으로 제공되는 데이터(값)
// return 결과값; (생략 가능)
//? 결과값(return, 리턴값): 함수가 작업 완료 후 반환한느 데이터(값) - return 키워드로 반환
// }

//? 함수 며명 규칙: lowerCamelCase 사용 + 동사 사용 권장
...
// 3) 화살표 함수
// : function 키워드 사용 안함, 해당 키워드를 화살표(=>)로 대체(간결한 작성), 함수명 사용 안함.
// > 호이스팅 적용 안됨
// +) 무조건 익명함수로 작성
...
//    , 함수 본문(구현부)이 단일문일 경우 중괄호 + return 키워드 생략 가능
...
// >> 지역변수는 해당 스코프를 벗어나면 사용 불가

/*
  함수 선언 방식에 따른 Best Practice

  - 일반적 상황: 선언문(function + 함수명 o)
  - 조건무 함수 사용: 함수 표현식(function + 함수명 선택)
  - 콜백 함수 사용: 화살표 함수(=> + 함수명 사용x)
