...
function Item({ name, isPacked }: ItemType) {
  ...
  // - if문: 가장명확, JSX 안에서 사용 불가 (return 위에서 처리)
  // - 삼항연산자 : JSX안에서 표현가능, 한줄로 간결
  // - 논리연산자 : "조건이 참인 경우에만 and", "조건이 거짓인 경우에만 and"
...
function I_Rendering() {
  ...
  //! === React 렌더링 시 key 속성 ===
  // : React에서 배열의각 항목을 식별하고 성능을 최적화 하기 위해 사용
  // - map()을 통해 여러 요소를 렌더링 할때, key는 React가 어떤 항복이 변경, 추가 또느 삭제 도이ㅓㅆ는지 ㅎ파악하는 용도로 사용
